...
| **Power Play (HTF)** | $\ge 100\%$ move in $\le 8$ weeks (`RUNUP >= 100`, `RUNUP_DAYS <= 40`) | Optional / Stage 2 Trend Template | Consolidates near high (`DAYS_SINCE_PEAK >= 10`) | Pullback $\le 25\%$ (`PULLBACK <= 25`) |
